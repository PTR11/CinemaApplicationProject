        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guests_ApplicationUser_Id",
                        column: x => x.Id,
                        principalTable: "ApplicationUser",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesMovies", x => new { x.CategoriesId, x.MoviesId });
                    table.ForeignKey(
                        name: "FK_CategoriesMovies_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoriesMovies_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuffetWarehouse", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuffetWarehouse_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActiveShow = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetRoles_Employees_EmployeesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BuffetSales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BuffetSales_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BuffetSales_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmployeeId = table.Column<int>(type: "int", nullable: false),
                    DutyTime = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Anonymus = table.Column<bool>(type: "bit", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rents_Movies_MoviesId",
                        column: x => x.MoviesId,
                        principalTable: "Movies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rents_Shows_ShowId",
                        column: x => x.ShowId,
                        principalTable: "Shows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rents_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_EmployeesId",
                table: "AspNetRoles",
                column: "EmployeesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuffetSales_EmployeeId",
                table: "BuffetSales",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_BuffetSales_ProductId",
                table: "BuffetSales",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_BuffetWarehouse_ProductId",
                table: "BuffetWarehouse",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesMovies_MoviesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rents_MoviesId",
                table: "Rents",
                column: "MoviesId");

            migrationBuilder.CreateIndex(
                name: "IX_Rents_ShowId",
                table: "Rents",
                column: "ShowId");

            migrationBuilder.CreateIndex(
                name: "IX_Rents_TicketId",
                table: "Rents",
                column: "TicketId");
