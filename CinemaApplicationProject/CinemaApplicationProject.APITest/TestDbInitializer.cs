...
namespace CinemaApplicationProject.APITest
{
    ...
    {
		public static void Initialize(DatabaseContext _context, UserManager<ApplicationUser> userManager)
		{
			...
			_ = userManager.CreateAsync(adminUser2, adminPassword).Result;
			_ = userManager.CreateAsync(guest, adminPassword).Result;
